...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@theliturgists/app";
  public static final String SHELL_APP_SCHEME = "theliturgists.app";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@theliturgists/app", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40theliturgists%2Fapp%2F0.0.1%2F4aa5ae5607fa9778f0c66b3b09563346-33.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
